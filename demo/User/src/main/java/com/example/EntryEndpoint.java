...
public class EntryEndpoint {
    ...
    CommandLineRunner commandLineRunnerTicket(UserService userService, RoleService roleService) {
        return args -> {
            ...
            userService.saveUser(new User("Stefan", "Enache", "stefy002.se@gmail.com","test","test"));
            userService.saveUser(new User("BUG", "Mafia", "bug@maf.com","pui","pass"));
            userService.saveUser(new User("Smile", "Argus", "simles.argus@vasile.com","ghita","ceva"));
